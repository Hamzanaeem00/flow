...
const Services = () => {
  ...
  return (
    <div
      className=" max-w-[85vw] mx-auto mt-40 grid grid-cols-12 gap-4"
      id="services"
    >
      ...
      >
        <h2 className="text-5xl xs:text-4xl sm:text-4xl md:text-4xl lg:text-5xl font-normal mb-12 xs:mb-4 sm:mb-5">
